...
namespace WinFormsApp1
{
    public partial class Form3 : Form
    {
        ...
        {
            // Example: Add product to cart before navigating
            // Replace "Product Name", quantity, and price with your actual product details
            // CartManager.AddProduct("Product Name from Form3", 1, 99.99m);
